set(_output_path "${CMAKE_CURRENT_BINARY_DIR}/rosidl_candb_generator_c/${PROJECT_NAME}")
...
set(target_dependencies
        "${rosidl_candb_generator_c_BIN}"
        ${rosidl_candb_generator_c_GENERATOR_FILES}
        "${rosidl_candb_generator_c_TEMPLATE_DIR}/msg.h.em"
        "${rosidl_candb_generator_c_TEMPLATE_DIR}/msg__pack.c.em"
        "${rosidl_candb_generator_c_TEMPLATE_DIR}/msg__unpack.c.em"
...
set(generator_arguments_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_candb_generator_c__arguments.json")
rosidl_candb_write_generator_arguments(
        "${generator_arguments_file}"
        PACKAGE_NAME "${PROJECT_NAME}"
        OUTPUT_DIR "${_output_path}"
        TEMPLATE_DIR "${rosidl_candb_generator_c_TEMPLATE_DIR}"
...
execute_process(
        COMMAND
        "${Python3_EXECUTABLE}" "${rosidl_candb_generator_c_BIN}"
...
add_custom_command(
        ...
        ARGS "${rosidl_candb_generator_c_BIN}"
...
set(_visibility_control_file "${_output_path}/rosidl_candb_generator_c__visibility_control.h")
string(TOUPPER "${PROJECT_NAME}" PROJECT_NAME_UPPER)
configure_file(
        "${rosidl_candb_generator_c_TEMPLATE_DIR}/rosidl_candb_generator_c__visibility_control.h.in"
        "${_visibility_control_file}"
        @ONLY
)
list(APPEND _generated_headers "${_visibility_control_file}")

set(_target_suffix "__rosidl_candb_generator_c")

add_library(
        "${rosidl_generate_interfaces_TARGET}${_target_suffix}" ${rosidl_generator_c_LIBRARY_TYPE}
        ${_out_generated_files} ${_visibility_control_file}
)
target_include_directories(
        "${rosidl_generate_interfaces_TARGET}${_target_suffix}" PUBLIC
        "$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/rosidl_candb_generator_c>"
...
target_link_libraries(
        ...
        "${rosidl_generate_interfaces_TARGET}__rosidl_typesupport_introspection_c"
...
set_property(
        ...
        PROPERTY DEFINE_SYMBOL "ROSIDL_CANDB_GENERATOR_C_BUILDING_DLL_${PROJECT_NAME}"
)
...
if(BUILD_TESTING AND rosidl_generate_interfaces_ADD_LINTER_TESTS)
    ...
    ament_cppcheck(TESTNAME "cppcheck_rosidl_candb_generated_c" "${_output_path}")

    find_package(ament_cmake_cpplint REQUIRED)
    get_filename_component(_cpplint_root "${_output_path}" DIRECTORY)
    ament_cpplint(
            TESTNAME "cpplint_rosidl_candb_generated_c"
    ...
    ament_uncrustify(
            TESTNAME "uncrustify_rosidl_candb_generated_c"
            # the generated code might contain longer lines for templated types
