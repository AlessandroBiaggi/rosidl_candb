#
# Generate a JSON file containing the rosidl candb generator arguments.
#
#
# @public
#
function(rosidl_candb_write_generator_arguments output_file)
    set(FLAG_KEYWORDS
            "STRICT"
    )
    ...
    if(ARG_UNPARSED_ARGUMENTS)
        message(FATAL_ERROR
                "rosidl_candb_write_generator_arguments() called "
    ...
    foreach(required_argument ${REQUIRED_ONE_VALUE_KEYWORDS})
        if(NOT ARG_${required_argument})
            message(FATAL_ERROR
                    "rosidl_candb_write_generator_arguments() must "
