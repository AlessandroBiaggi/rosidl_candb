set(_output_path "${CMAKE_CURRENT_BINARY_DIR}/rosidl_candb_generator_base/${PROJECT_NAME}")
...
set(target_dependencies
        "${rosidl_candb_generator_base_BIN}"
        ${rosidl_candb_generator_base_GENERATOR_FILES}
...
set(generator_arguments_file "${CMAKE_CURRENT_BINARY_DIR}/rosidl_candb_generator_base__arguments.json")
...
execute_process(
        COMMAND
        "${Python3_EXECUTABLE}" "${rosidl_candb_generator_base_BIN}"
...
add_custom_command(
        ...
        ARGS "${rosidl_candb_generator_base_BIN}"
...
set(_target_suffix "__rosidl_candb_generator_base")

add_library(
        "${rosidl_generate_interfaces_TARGET}${_target_suffix}" ${rosidl_candb_generator_base_LIBRARY_TYPE}
        ${_out_generated_files}
)
target_include_directories(
        "${rosidl_generate_interfaces_TARGET}${_target_suffix}" PUBLIC
        "$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/rosidl_candb_generator_base>"
...
if(BUILD_TESTING AND rosidl_generate_interfaces_ADD_LINTER_TESTS)
    ...
    ament_cppcheck(TESTNAME "cppcheck_rosidl_candb_generated" "${_output_path}")

    find_package(ament_cmake_cpplint REQUIRED)
    get_filename_component(_cpplint_root "${_output_path}" DIRECTORY)
    ament_cpplint(
            TESTNAME "cpplint_rosidl_candb_generated_base"
    ...
    ament_uncrustify(
            TESTNAME "uncrustify_rosidl_candb_generated_base"
            # the generated code might contain longer lines for templated types
