...
class TemplateContext:
    ...
    def evaluate_template(
        ...
        locals = dict(locals) if locals is not None else dict()

        all_resolve_paths = (
            set([
                *[pathlib.Path(p).absolute() for p in resolve_paths],
                *self._resolve_paths
            ])
            if resolve_paths is not None
        ...
        try:
            if (
                ...
                locals['TEMPLATE'] = (
                    ...
                    self._recursively_evaluate_template(
                        ...
                        resolve_paths=(
                            set([*recursive_resolve_paths, *all_resolve_paths])
            ...
            locals = dict(**self._globals, **locals)
    ...
    def _recursively_evaluate_template(
        ...
        try:
            ...
            locals = dict(**self._globals, **kwargs)
